                            ...
                            <div class="text-center">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <button onclick="modalAction('{{ url('profile/edit_picture') }}')"
                                        ...
                                        style="bottom: 0; right: 5%;"><i class="fa-solid fa-pencil"></i></button>
                                </div>
                            </div>
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3" src="adminlte/dist/img/photo2.png"
                                                            alt="Photo">
                                                        <img class="img-fluid" src="adminlte/dist/img/photo3.jpg"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3" src="adminlte/dist/img/photo4.jpg"
                                                            alt="Photo">
                                                        <img class="img-fluid" src="adminlte/dist/img/photo1.png"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                </div>
